    ...
    public IEnumerator InitAsync(System.Action<float> onProgress)
    {
        ...
        yield return LoadCsvDataAsync(
            ...
            createData: (values, columns) => new MonsterData(
                ...
                hpIncreasePerWave: values.GetInt(columns, "HPIncreasePerWave"),
                damage: values.GetInt(columns, "Damage"),
                damageIncreasePerWave: values.GetInt(columns, "DamageIncreasePerWave"),
                ...
                scoreIncreasePerWave: values.GetLong(columns, "ScoreIncreasePerWave"),
        ...
        yield return LoadCsvDataAsync(
            ...
            createData: (values, columns) => new UpgradeData(
                ...
                param1: values.GetFloat(columns, "Param1"),
                param2: values.GetFloat(columns, "Param2"),
